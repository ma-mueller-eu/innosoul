    ...
    <section id="hero" style={{
      ...
      <div style={{ maxWidth: 820, textAlign: 'center', position: 'relative' }}>
        ...
        <p style={{
          ...
          color: 'rgba(255,255,255,0.7)', maxWidth: 640, margin: '0 auto 40px',
        }}>
        ...
        <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 60 }}>
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = '#087F5B'; e.currentTarget.style.transform = 'translateY(-1px)' }}
            onMouseLeave={(e) => { e.currentTarget.style.background = '#109870'; e.currentTarget.style.transform = 'translateY(0)' }}
          >
            Erstgespräch vereinbaren
          </button>
          <button
            onClick={() => onNav('leistungen')}
            style={{
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 28 }}>
          <p style={{ fontSize: 11, fontFamily: 'DM Sans', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)', marginBottom: 14 }}>
            Förderprogramme
          </p>
