    ...
    <div style={{
      ...
      {isPlaceholder ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          ...
          <div style={{ marginTop: 8, fontSize: 12, fontFamily: 'DM Sans', color: 'rgba(255,255,255,0.25)' }}>Erfolgsgeschichte in Vorbereitung</div>
        </div>
      ) : (
        <>
...
const References = () => (
  <section id="referenzen" style={{ background: '#1A2238', padding: '96px 32px' }}>
